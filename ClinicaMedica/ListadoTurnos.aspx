...
<body>
    <form id="form1" runat="server">
        <div class="header">
            <section>
                <asp:ImageButton ID="btnUserImg" runat="server" ImageUrl="Estilo/user.png" CssClass="user-image" OnClick="btnUserImg_Click" Visible="False" Style="transform: translateY(-3px); margin-left: 2px" />           
