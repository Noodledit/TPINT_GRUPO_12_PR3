    ...
    <form id="form1" runat="server">
        <div class="header">
            ...
            <div class="titulo-header">
                ...
                <div class="header-links">
                    ...
                    <asp:HyperLink ID="hlSeguimientoPaciente" runat="server" CssClass="header-link" Text="Seguimiento Paciente" Visible="False" TabIndex="4" NavigateUrl="~/SeguimientosPacientes.aspx"></asp:HyperLink>
        ...
        <div class="contenido">
            <div class="solapa">
                ...
                <asp:GridView ID="gvTurnos" runat="server" AutoGenerateColumns="False" CssClass="tabla-turnos" AllowPaging="True" OnPageIndexChanging="gvTurnos_PageIndexChanging" PageSize="15" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" AutoGenerateSelectButton="True" OnRowDeleting="gvTurnos_RowDeleting" OnRowEditing="gvTurnos_RowEditing" OnSelectedIndexChanged="gvTurnos_SelectedIndexChanged" OnRowUpdating="gvTurnos_RowUpdating">
                    <Columns>
