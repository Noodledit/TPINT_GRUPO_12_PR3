    ...
    <form id="form1" runat="server">
        ...
        <div class="contenido">
            <div class="solapa">
                ...
                <asp:GridView ID="gvTurnos" runat="server" AutoGenerateColumns="False" CssClass="tabla-turnos" AllowPaging="True" OnPageIndexChanging="gvTurnos_PageIndexChanging" PageSize="15">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Estado">
                            <ItemTemplate>
                                <asp:Label ID="lbl_it_Estado" runat="server"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
